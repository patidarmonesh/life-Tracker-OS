...
import { saveGeminiApiKey, testGeminiApiKey } from '../services/geminiService'
...
export default function Settings() {
  ...
  async function testGeminiKey() {
    ...
    try {
      ...
      saveSettings(profile, { ...preferences, geminiApiKey: key })
  ...
  return (
    <div style={{ maxWidth: '920px', margin: '0 auto' }}>
      ...
      <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <Card>
          {sectionTitle(<KeyRound size={18} />, 'API Keys', 'Store Gemini API key locally and test connectivity placeholders.')}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '10px', alignItems: 'end' }}>
            <div>
              ...
              <input
                ...
                onChange={e => updatePref('geminiApiKey', e.target.value)}
              />
            </div>
