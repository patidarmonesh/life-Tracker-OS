...
import { Plus, Search, Trash2, BookOpen, Smile } from 'lucide-react'
...
export default function Journal() {
  ...
  return (
    <div style={{ maxWidth: '820px', margin: '0 auto' }}>
            ...
            {filteredEntries.length === 0 ? (
              <Card>
                <div style={{ textAlign: 'center', padding: '40px', color: 'var(--text-muted)' }}>
                  ...
                  <div style={{ fontSize: '15px', fontWeight: '600', color: 'var(--text-secondary)' }}>No journal entries yet</div>
                  <div style={{ fontSize: '13px', marginTop: '4px', marginBottom: '16px' }}>Start writing daily reflections, wins, and thoughts.</div>
                  <Button onClick={() => setShowNewModal(true)}>
      ...
      <Modal isOpen={showNewModal} onClose={() => setShowNewModal(false)} title="New Journal Entry">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div>
            ...
            <input
              ...
              placeholder="work, gym, family, stress"
              style={inputStyle}
            />
          </div>
